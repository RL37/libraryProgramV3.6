...
public class Main {
        ...
        do{
            ...
            switch (menuOptionInput) {
                ...
                case 2: //adds a new book and saves it to the array
                    Books bookDetails = getBookDetails();
                    saveBookDetailsToArray(String.valueOf(bookDetails));
                    saveDetailsToFile(String.valueOf(bookDetails),fileToAccess);
                    break;
    ...
    public static Books getBookDetails(){
        Books myNewBook = new Books(getInput("What is the book called:"),getInput("What is the book ISBN number:"),getInput("Who is the author"),getInput("What is the books genre:"));
        return myNewBook;
        /*
